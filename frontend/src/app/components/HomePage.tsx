        ...
        <section className={style.bg}>
            <div className={style.text}>
                ...
                <h3 className={style.h3}>Your musical journey starts here! Our app uses AI to generate 
                    ...
                    progression. To top it off, we’ll create a personalized playlist just for you, so 
                    you can explore tracks that match your vibe. Whether you're creating your own music 
                    or just looking for fresh tunes, The Consonance brings the power of music and AI together 
                    in one easy-to-use platform!</h3>
